        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="px-44">
                <div class="flex w-full justify-between items-center mt-10 ">
                    <h1 class="text-2xl font-semibold text-gray-800">Tambah Kategori Produk</h1>
                </div>
                <div class="relative overflow-x-auto py-5 rounded-md">
                    <form action="{{route('category.store')}}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="category_name" id="category_name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
